<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="violatorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="违法地点" align="center" prop="illegalPlace" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="举报人" prop="informant" required>
          <el-input v-model="form.informant" placeholder="请输入举报人" />
        </el-form-item>
        <el-form-item label="举报者身份证号" prop="informantIdNumber" required>
          <el-input v-model="form.informantIdNumber" placeholder="请输入举报者身份证号" />
        </el-form-item>
        <el-form-item label="举报者手机号" prop="informantPhone" required>
          <el-input v-model="form.informantPhone" placeholder="请输入举报者手机号" />
        </el-form-item>
        <el-form-item label="违法者车牌号" prop="violatorCarNumber" required>
        ...
        <el-form-item label="违法行为" prop="illegalActivities" required>
