    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="违法计分" prop="illegalScoring">
          <el-input v-model="form.illegalScoring" placeholder="请输入违法计分" disabled/>
        </el-form-item>
        <el-form-item label="违法罚款" prop="illegalFines">
          <el-input v-model="form.illegalFines" placeholder="请输入违法罚款" disabled/>
        </el-form-item>
...
<script>
import { handlingListViolator, getViolator, delViolator } from "@/api/system/violator";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      handlingListViolator(this.queryParams).then(response => {
